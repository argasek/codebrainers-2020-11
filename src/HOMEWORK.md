...
Add sorting (ascending / descending, toggleable) by
Blooming in Plants table.

### Task 2.

Add sorting (ascending / descending, toggleable) by
Watering Interval in Plants table.

Hint: in order to solve this task please figure out
what value is being represented by question mark ("?")
in the table rows.

### Task 3.*

Notice that our Plants table can be scrolled horizontally.
This reveals two other columns called "Last watered"
and "Last fertilized". They represent dates when a plant
has been recently watered or fertilized.

Implement ascending and descending sorting of these columns.
